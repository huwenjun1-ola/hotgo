...
--
-- Table structure for table `hg_admin_member_role`
--
...
--
-- Dumping data for table `hg_admin_member_role`
--

LOCK TABLES `hg_admin_member_role` WRITE;
/*!40000 ALTER TABLE `hg_admin_member_role` DISABLE KEYS */;
INSERT INTO `hg_admin_member_role` VALUES (1,1),(2,2);
/*!40000 ALTER TABLE `hg_admin_member_role` ENABLE KEYS */;
UNLOCK TABLES;
